...
- `assistant` (`real-media-composition-call:turn-1:answer`): Недостаточно подтверждённых фрагментов локальной базы для ответа на ваш вопрос о логисте. Предлагаю подключить оператора.
